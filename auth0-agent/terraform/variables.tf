...
# NOTE: These defaults are overridden by terraform.tfvars (generated by scripts/generate-auth-management-client.sh)
# To change the agent URL, edit ../config.sh and regenerate the tfvars file
...
# NOTE: This default is overridden by terraform.tfvars (generated with /mcp suffix)
