...
2. After enabling Push Notifications, you'll want to enroll your user for CIBA. Here's one of easy way of achieving that:
   * Navigate to **User Management -> Users** and select your user oidc|demotradepro user
   * Within the **Details** tab, scroll down to **Multi-Factor Authentication** and select **Enroll user in MFA**.
...
Select the [Bonus: AI-native Tools](/native-ai-tools) section when you are ready to turn it up to eleven! 🎵 🎸