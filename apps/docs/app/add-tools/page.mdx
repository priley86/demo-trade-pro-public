...
graph TB
    subgraph "Public Tools Added"
        User[👤 User]
        Agent[🤖 AI Agent<br/>:3003]
        API[📊 Stock API<br/>:3001]
        Tools[🔧 Public Tools<br/>@workspace/agent-utils]
    end
...
- ✅ `searchStocks` - Find companies by name/symbol
- ✅ `getStockInfo` - Get company details
...
- ✅ `ai` - AI SDK v5 with streamText
- ✅ `@ai-sdk/openai` - OpenAI provider
- ✅ `@workspace/agent-utils` - Shared tools package
- ✅ Working chat interface with useChat hook
- ✅ Empty tools configuration ready for your code
...
**What these tools do:**
- ✅ `getStockPrice` - Get current price for any stock symbol
- ✅ `searchStocks` - Find stocks by company name
- ✅ `getStockInfo` - Get detailed company information
