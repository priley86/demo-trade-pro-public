...
AI Agents can't just interact with the outside world on their own, instead we need to provide them integrations. Our agent today uses [Vercel AI SDK](https://ai-sdk.dev) 
