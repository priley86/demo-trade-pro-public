...
sequenceDiagram
    ...
    participant Agent as 🤖 Agent Tenant<br/>:3003
    participant Vault as 🔐 Auth0 Token Vault<br/>(Agent Tenant)
    participant Root as 🏦 Root Tenant<br/>(DemoTradePro)
...
- ✅ **Token Vault** - Secure token storage + automatic refresh (<ExternalLink href="https://auth0.com/docs/secure/tokens/token-vault/call-apis-with-token-vault">Auth0 docs</ExternalLink>)
...
- ✅ **Portfolio tools** - `getPortfolio`, `getOrderHistory`, `createOrder`
...
- *"Show me my WAYNE holdings and current price"*

---

## Next: Add more authenticated tools

TODO: Let's add CIBA mentions here and lead into next page about CIBA usage with the agent... 
