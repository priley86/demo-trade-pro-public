...
sequenceDiagram
    ...
    participant Root as 🏛️ Root Tenant<br/>(DemoTradePro)
...
- ✅ **Token Vault** - Secure token storage + automatic refresh ([Auth0 docs](https://auth0.com/docs/secure/tokens/token-vault/call-apis-with-token-vault))
...
## 2 – Add Auth0 Token Vault helper
