...
export default function StockDetail() {
  ...
  const currentValue = currentHolding ? Number.parseFloat(stock.price) * currentHolding.shares : 0
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="text-2xl font-bold">{currentHolding.shares}</div>
                    </div>
                    <div>
                  ...
                  <div className="pt-4 border-t">
                    ...
                    <div className="text-lg font-bold text-green-600">+${(currentValue * 0.05).toFixed(2)} (+5.0%)</div>
                  </div>
                </div>
              ) : (
